...
int firstcount = 0; //global count variable when reader first starts the first string shouldn't be read
...
int main()
{
  ...
  const char* c1;  
  bool run = false;//used to signal if string has correct length
